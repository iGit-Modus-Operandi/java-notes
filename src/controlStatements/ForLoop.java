...
* IMPLEMENTATION: In its most common form, the initialization portion of the loop sets a loop control
* variable to an initial value. The condition is a Boolean expression that tests the loop control variable.
